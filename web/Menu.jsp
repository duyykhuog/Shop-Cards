    ...
    <head>
        ...
        <style>
            ...
            .balance-container {
                ...
                color: white;
                margin-right: 1rem;
                line-height: 40px; /* Adjust to match the navbar height */
            }
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <c:if test="${sessionScope.acc.isAdmin == 1}">
                                        <a class="dropdown-item" href="usermanager">Manager Account</a>
                                        <a class="dropdown-item" href="manager">Manager Product</a>
                                        <a class="dropdown-item" href="category">Manager Category</a>
